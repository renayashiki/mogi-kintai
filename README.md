...
## 動作確認用情報
### テスト用アカウント
- 以下のダミーデータ情報でログインすることが可能です。本アプリでは、ログイン後すぐに「商品一覧」や「購入」のテストができるよう、以下のユーザーに初期プロフィールのみ紐付けています。
...
```
> 仕様書指定のデータ(全10商品)の出品者本人のため、「おすすめ」表示は空になります。
